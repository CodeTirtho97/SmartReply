...
public class EmailGeneratorService {
    ...
    public EmailGeneratorService(WebClient.Builder webClientBuilder) {
        ...
        log.error("Invalid Gemini API URL configuration: {}", geminiApiUrl);
        throw new IllegalStateException("Gemini API URL contains unresolved placeholder: " + geminiApiUrl);
    }
